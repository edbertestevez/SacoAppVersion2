...
public class SavingsActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new SavingsFragmentAll(),"All");
        adapter.addFragment(new SavingsFragmentToday(),"Today");
        adapter.addFragment(new SavingsFragmentMonth(),"Month");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(SavingsActivity.this, SavingsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_expenses) {
            Intent intent = new Intent(SavingsActivity.this, ExpenseActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_borrow_return) {
            Intent intent = new Intent(SavingsActivity.this, BorrowReturnActivity.class);
            startActivity(intent);
            ...
            if(isNetworkAvailable()) {
                ...
                editor.commit();
                Intent intent = new Intent(SavingsActivity.this, LoginActivity.class);
                startActivity(intent);
            }else{
